...
class AES256 extends \booosta\crypter\Crypter
{
  ...
  public function encrypt($plaintext)
  {
    ...
    return base64_encode(openssl_encrypt($plaintext, $this->cipher, base64_decode($this->key), 0, $this->iv));
  }
  ...
  public function decrypt($ciphertext)
  {
    ...
    return openssl_decrypt(base64_decode($ciphertext), $this->cipher, base64_decode($this->key), 0, $this->iv);
  }
